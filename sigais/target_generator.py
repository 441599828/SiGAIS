...
class SigaisTargetGenerator(object):
    """
    ...
    def __call__(self, panoptic, segments_info):
        ...
        ft_mask = np.zeros_like(panoptic, dtype=np.uint8)
